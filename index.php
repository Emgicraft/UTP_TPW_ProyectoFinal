...
<header class=cabezaWeb>
    <div>
        ...
        <img src="media/https://i.imgur.com/d3V0t5C.png" alt="Logo_MaghTech" width="100px">
    </div>
...
<main>
    ...
    <article class="principal">
        ...
        <img id="carne_cocinada" width="35%" src="https://i.imgur.com/OADKXGi.jpg" alt="Corte de carne cocinado.">
...
<footer>
    <div class="derechoCopy">
        <img src="media/logo.png" width="7%">
        <p class="derechoCopy">&copy Copyright Sabor&Frescura - 2024</p>
    </div>
</footer>
</body>
</html>