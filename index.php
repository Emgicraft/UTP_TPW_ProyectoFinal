...
<body>
	...
	<img width="100%" src="banner/banner2.jpg">

	<main>

		<section class="principal">

			<h2 class="titulo-principal">Sobre Sabor&Frescura</h2>

			<img class="utensilios" src="imagenes/Embutidos.jpg" alt="Utensilios de un barbero.">
	...
	<section class="mapa" align="center">
	...
	<section class="diferenciales">
		<div class="video" align="center">
			<iframe width="560" height="315" src="https://www.youtube.com/embed/ARHXAj-n18Q?si=wDvGsMQWY47u4p8k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
		</div>
	</section>
	...
	<!-- Pie de pagina -->
	<footer align="center">
		<img src="imagenes/PiePAgina.png">
		<p class="copyrigth">&copy Copyright Sabor&Frescura - 2024</p>
	</footer>
